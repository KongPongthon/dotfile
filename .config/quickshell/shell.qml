...
ShellRoot {
    ...
    readonly property var allHotkeys: [
        ...
        { "category": "tools", "title": "Random Wallpaper", "desc": "สุ่มวอลเปเปอร์", "keys": ["SUPER", "SHIFT", "W"], "action": "" },
        ...
        { "category": "system", "title": "Toggle Theme", "desc": "สลับ Rumda Dark / Light", "keys": ["SUPER", "SHIFT", "T"], "action": "theme-switcher toggle" },
